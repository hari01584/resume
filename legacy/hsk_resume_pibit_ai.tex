...
\section{Projects}
  \resumeSubHeadingListStart
      ...
      {An application where user can book operators for \textbf{doorstep Aadhar updation}. Winner of Smart India Hackathon 2022 (Team SHARK), \textbf{awarded 1 lakh rupees}. (Flutter, Django, Flask, FastAPI) \href{https://www.linkedin.com/posts/hsk4link_sih-sih2022-smartindiahackathon-activity-6970324738409672704-YcQA/}{\textbf{Link (Linkedin Post)}}}
      % \resumeSubItem{Finfy}
    ...
    %   {A \textbf{novels reader and management application}, it includes offline reading, different font/styles settings and library of reads with progress (Android Native, Java) \href{https://github.com/hari01584/NovelNation}{\textbf{Link (GitHub)}}}
      ...
      {Conducted NLP project analyzing millions of tweets on a specific topic, providing valuable insights for policymakers, market analysis, and trend identification. Published a research paper on the same! (Python, Pandas/Dask, Numpy)}
